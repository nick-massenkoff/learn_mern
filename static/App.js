...
var IssueAdd = function (_React$Component4) {
  ...
  function IssueAdd(props) {
    ...
    var _this4 = _possibleConstructorReturn(this, (IssueAdd.__proto__ || Object.getPrototypeOf(IssueAdd)).call(this, props));
...
var IssueList = function (_React$Component5) {
  ...
  _createClass(IssueList, [{
    ...
    value: function loadData() {
      ...
      this.axios.get('issues').then(function (res) {
        console.log('Total num of records: ' + res.data._metadata.total_count);
        res.data.records.forEach(function (issue) {
          issue.created = new Date(issue.created);
          if (issue.completionDate) issue.completionDate = new Date(issue.completionDate);
        });
        _this6.setState({ issues: res.data.records });
      }).catch(function (err) {
        console.log(err);
      });
    }
    ...
    value: function createIssue(newIssue) {
      ...
      this.axios.post('issues', newIssue).then(function (res) {
        res.data.created = new Date(res.data.created);
        if (res.data.completionDate) res.data.completionDate = new Date(res.data.completionDate);
        var newIssues = _this7.state.issues.concat(res.data);
